...
function ProductEditScreen() {
    ...
    const uploadFileHandler =  async (e) => {
       ...
       formDate.append('product_id', productId)
       ...
       try{
        ...
        const {data} = await axios.post(`/api/products/upload/`, formDate, config)
    ...
    <FormContainer>
        ...
        {loading ? <Loader/> : error ? <Message variant='danger'>{error}</Message> : (
            ...
            <Form.Group controlId='image'>
                ...
                <Form.Control type='file'  custom style={{color: 'blue', background: 'black'}} onChange={uploadFileHandler}>
